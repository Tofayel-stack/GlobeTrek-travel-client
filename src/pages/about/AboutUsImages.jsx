...
const AboutUsImages = () => {
    return (
        ...
        <img data-aos="fade-left" data-aos-duration="400" data-aos-delay="50" 
            className="object-cover mb-6 rounded shadow-lg h-28 sm:h-48 xl:h-56 w-28 sm:w-48 xl:w-56 hover:scale-105 duration-700"
            src={about1}
            alt="designWeb"
        />
        <img data-aos="fade-left" data-aos-duration="600" data-aos-delay="50" 
        ...
        <div className="px-3">
        <img data-aos="fade-left" data-aos-duration="800" data-aos-delay="50" 
